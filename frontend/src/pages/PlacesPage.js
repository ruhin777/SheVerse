...
export default function PlacesPage() {
  ...
  const handlePlanTrip = (place) => {
    localStorage.setItem("planTrip", JSON.stringify({
      destination: place.city,
      category: place.category
    }));
    navigate("/travel/trips?tab=plan");
  };
              ...
              >
                ...
                <div style={S.cardBody}>
                  ...
                  <div style={S.btnRow}>
                    ...
                    <button style={S.planBtn} onClick={() => handlePlanTrip(p)}>
                      Plan Trip
                    </button>
                  </div>
                </div>
      ...
      {panel && (
        <div style={S.modalOverlay} onClick={() => setPanel(null)}>
          <div style={S.modal} onClick={(e) => e.stopPropagation()}>
            ...
            {/* Plan Trip from panel */}
            <button
              style={S.panelPlanBtn}
              onClick={() => { handlePlanTrip(panel.place); setPanel(null); }}
            >
              Plan a Trip to {panel.place.city}
            </button>
...
const S = {
  ...
  exploreBtn:   { flex: 1, padding: "8px 12px", background: "transparent", border: "1px solid #9d4edd", color: "#9d4edd", borderRadius: 20, cursor: "pointer", fontSize: 12, fontFamily: "sans-serif", letterSpacing: 1 },
  planBtn:      { flex: 1, padding: "8px 12px", background: "linear-gradient(135deg,#9d4edd,#c77dff)", color: "#fff", border: "none", borderRadius: 20, cursor: "pointer", fontSize: 12, fontFamily: "sans-serif", letterSpacing: 1 },
  ...
  modalDesc:    { fontSize: 14, color: "#6b5b7b", lineHeight: 1.8, marginBottom: 16, fontFamily: "sans-serif" },
  panelPlanBtn: { width: "100%", padding: "11px", background: "linear-gradient(135deg,#9d4edd,#c77dff)", color: "#fff", border: "none", borderRadius: 10, cursor: "pointer", fontSize: 13, fontFamily: "sans-serif", letterSpacing: 1, marginBottom: 20 },
